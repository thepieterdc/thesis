...
ggplot(data, aes(idx)) +
  ...
  geom_line(aes(y = Rocket, color = "ROCKET")) +
  ggtitle("Performance of the ROCKET algorithm on Stratego") +
  labs(x = "Test run", y = "# test cases before first failure") +
  scale_color_manual(name = "Algorithm", values = c("Original" = "gray", "ROCKET" = "red")) +
