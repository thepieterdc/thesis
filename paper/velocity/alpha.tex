...
\label{alg:alpha}
\begin{algorithmic}[1]
	\Require{the test suite $TS$, the affected testcases $AS \subseteq TS$, all coverable lines $C$, execution time $E$ of every test case over $k$ runs, failure status $F$}
