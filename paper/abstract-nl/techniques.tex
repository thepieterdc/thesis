...
\begin{itemize}
	...
	\item $\{T_1, \dots, T_m\}$ deelverzamelingen van tests uit $T$. Elke deelverzameling $T_i$ wordt geassocieerd met een vereiste $r_i$, zodanig dat eender welke test $t_j \in T_i$ kan worden uitgevored om te voldoen aan vereiste $r_i$.
\end{itemize}
\mbox{}\\
...
\begin{itemize}
	...
	\item $f: PT \mapsto \mathbb{R}$ een functie die een deelverzameling afbeeldt op een re\"eel getal. Deze functie wordt gebruikt om permutatise met elkaar te vergelijken.
\end{itemize}
\mbox{}\\
