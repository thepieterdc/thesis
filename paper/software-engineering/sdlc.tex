...
\begin{listing}
	\lstinputlisting[language=java]{assets/listings/example-unit-test.java}
...
\begin{listing}
	\lstinputlisting[language=java]{assets/listings/example-integration-test.java}
	\caption{Example of a Java integration test in JUnit.}
	\label{lst:se-integration-test}
\end{listing}
...
\begin{listing}
	\lstinputlisting[language=java]{assets/listings/example-regression-test.java}
	\caption{Example of a Java regression test in JUnit.}
	\label{lst:se-regression-test}
\end{listing}